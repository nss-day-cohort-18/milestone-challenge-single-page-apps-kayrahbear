...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- //4 grid wide card -->\r\n<div id=\"card--"
    ...
    + " "
    + alias4(((helper = (helper = helpers.make || (depth0 != null ? depth0.make : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"make","hash":{},"data":data}) : helper)))
    + " "
  ...
  return "<!-- //Handlebars template that will format the called values of each car from the json file. Uses bootstrap columns and card classes -->\r\n\r\n<!-- //does for each car listed in the json -->\r\n"
